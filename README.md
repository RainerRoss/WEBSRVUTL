# WEBSRVUTL
Web Service Utilities running on IBM i for providing <strong>*superfast* Web Services</strong> and running <strong>Webapplications</strong> powered by IBM i based on AJAX-Requests
